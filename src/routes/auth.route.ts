 ...
 *   post:
 *     summary: Register a new user (legacy method)
 *     tags: [Authentication]
 *     security: []
 *     requestBody:
 *       required: true
 ...
 *   post:
 *     summary: Verify email with token (legacy method)
 *     tags: [Authentication]
 *     security: []
 *     requestBody:
 *       required: true
 ...
 *                 message:
 *                   type: string
 *                   example: If an account exists, an OTP has been sent to your email
 */
router.post(
 ...
 *   post:
 *     summary: Reset password with token (legacy method)
 *     tags: [Authentication]
 *     security: []
 *     requestBody:
 *       required: true
...
router.post(
  ...
  passwordResetLimiter,
  validateRequest(validateEmailForOtp),
...
router.post(
  ...
  passwordResetLimiter,
  validateRequest(validatePasswordResetOtp),
  authController.resetPasswordWithOtp
);

/**
 * @swagger
 * /api/v1/auth/verify-email/verify-otp:
 *   post:
 *     summary: Verify email using OTP (requires authentication)
 *     tags: [Authentication - OTP]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *   post:
 *     summary: Resend email verification OTP (requires authentication)
 *     tags: [Authentication - OTP]
 *     security:
 *       - bearerAuth: []
 *     responses:
